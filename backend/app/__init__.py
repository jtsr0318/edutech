    ...
    def _startup_db_compat() -> None:
        with app.app_context():
            ...
            try:
                ...
                ensure_column("materials", "file_mime", "ALTER TABLE materials ADD COLUMN file_mime VARCHAR(128) NULL")
                ensure_column("materials", "file_blob", "ALTER TABLE materials ADD COLUMN file_blob LONGBLOB NULL")
                ensure_column("assignments", "attachment_mime", "ALTER TABLE assignments ADD COLUMN attachment_mime VARCHAR(128) NULL")
                ensure_column("assignments", "attachment_blob", "ALTER TABLE assignments ADD COLUMN attachment_blob LONGBLOB NULL")
