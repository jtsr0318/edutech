...
def create_app() -> Flask:
    ...
    with app.app_context():
        ...
        # On a fresh Railway DB (no schema yet), ALTER/CREATE may fail — do not crash the whole app.
        ...
        try:
            ...
            # After a failed connect, rollback() can try to open another connection and crash the worker.
            try:
                db.session.rollback()
            except Exception:
                pass
